...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:hypesquad1:750076071721828452> **Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
 ...
 if(!rol) return message.reply(`<a:hypesquad1:750076071721828452>  **Ayarlanmamış bir özellik sıfırlanamaz! :wink: **`)
 
 
  message.channel.send(`<a:hypesquad1:750076071721828452>  **Otorol mesajı başarılı bir şekilde sıfırlandı.**`)
